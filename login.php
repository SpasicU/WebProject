...
class="close" title="Close Modal">&times;</span>
  ...
  <form class="modal-content animate" action="login.php">
    ...
    <div class="container">
      ...
      <input type="text" placeholder="Upišite Vaše korisničko ime" name="nIme" required>

      <label for="nPass"><b>Šifra</b></label>
      <input type="password" placeholder="Upišite šifru" name="nPass" required>
